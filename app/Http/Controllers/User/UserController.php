...
{
    protected $user, $booking, $review, $focusArea, $userGiftVoucher, $userFaqRepo, $userPack, $userPackOrder, $userPackGift, $getRequest;
    ...
    public function savePackGifts()
    {
        return $this->userPackGift->create($this->getRequest);
    }
}
